...
class TestIncrementalOneClassSVMAdaptiveKernel(unittest.TestCase):
    ...
    def test_basic_functionality(self):
        ...
        model = IncrementalOneClassSVMAdaptiveKernel(nu=0.05, sv_budget=100, initial_gamma=0.5, adaptation_rate=0.3, gamma_bounds=(0.1, 5.0))
        ...
        self.assertGreaterEqual(correct, 80, "At least 80% of normal samples should be predicted as normal")
