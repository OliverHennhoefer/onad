...
class TestIncrementalOneClassSVM(unittest.TestCase):
    ...
    def test_gradient_updates_modify_parameters(self):
        ...
        svm = IncrementalOneClassSVM(learning_rate=0.5)  # High learning rate for visible changes
        ...
        self.assertFalse(np.array_equal(initial_w, svm.w), "Weight vector should change")
