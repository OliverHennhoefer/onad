...
class TestRandomModel(unittest.TestCase):
    ...
    def test_returns_random_scores_in_range(self):
        ...
        self.assertGreater(len(unique_scores), 50, 
                          "Expected more variety in random scores")
    ...
    def test_different_seeds_produce_different_results(self):
        ...
        different_count = sum(1 for s1, s2 in zip(scores1, scores2) if s1 != s2)
        self.assertGreater(different_count, 95, 
    ...
    def test_score_stability_after_learning(self):
        ...
        self.assertNotEqual(score1, score2, "Random model should produce different scores")
