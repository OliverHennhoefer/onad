...
class TestAutoencoder(unittest.TestCase):
    ...
    def test_training_mode_switching(self):
        ...
        initial_training = model.model.training
        ...
        self.assertFalse(model.model.training, "Model should be in eval mode after score_one")
    ...
    def test_gradient_updates(self):
        ...
        architecture = VanillaAutoencoder(input_size=3, seed=42)
        optimizer = optim.SGD(architecture.parameters(), lr=1.0)  # High LR for visible changes
        criterion = nn.MSELoss()
        ...
        self.assertGreater(changed_params, 0, "Expected some parameters to change during training")
